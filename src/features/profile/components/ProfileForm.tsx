  ...
  return (
    <main className="mx-auto w-full max-w-[420px] px-4 pt-5 pb-28">
      ...
      <section className="rounded-2xl border border-black/10 bg-white p-4 shadow-[0_10px_28px_rgba(0,0,0,0.06)] space-y-3">
        <label className="block text-[12px] font-semibold text-black/50">имя</label>
        ...
        <p className="text-[12px] font-medium text-black/45">связь — только через Telegram (@username из mini app)</p>
